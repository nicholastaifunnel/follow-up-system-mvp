...
const DEFAULT_TEMPLATES = [
  {
    name: "Default Google Review - First Message",
    messageStage: "First Message",
    body: `Hi, I found {businessName} on Google Maps.
...
Can I send you 2 quick suggestions?`,
  ...
  {
    name: "Default Google Review - First Follow Up",
    messageStage: "First Follow Up",
    body: `Hi, just following up about {businessName}.
...
Would you like me to show you a quick example?`,
  ...
  {
    name: "Default Google Review - Second Follow Up",
    messageStage: "Second Follow Up",
    body: `Hi, last follow up from me.
